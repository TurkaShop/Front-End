    ...
    <>
      <div className='contacts__border'>
        ...
        <div className='contacts'>
          ...
          <p className='contacts__text'>Контакти виробництва:</p>
          <p className='contacts__description'>м. Київ, вул. Архітектора Ніколаєва, 7</p>
          ...
          <div>
              <p className='contacts__description'>м. Київ, вул. Градинська, 3</p>
