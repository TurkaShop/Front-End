        ...
        <div className={css.menu}>
          <ul className={css.menu__list_left}>
            ...
            <li className={css.menu__item}>
              <a href="index.html" className={css.footer__link}>Торти</a>
            </li>
        ...
        <div className={css.about}>
          <ul className={css.menu__list_middle}>
            ...
            <li className={css.about__item}>
              <a href="index.html" className={css.footer__link}>Оферта</a>
            </li>

            <li className={css.about__item}>
              <a href="index.html" className={css.footer__link}>Співпраця</a>
            </li>

            <li className={css.about__item}>
              <a href="index.html" className={css.footer__link}>Статті</a>
            </li>
          </ul>
        </div>
        ...
        <div className={css.forcustomers}>
          <ul className={css.menu__list_right}>
            ...
            <li className={css.forcustomers__item}>
              <a href="index.html" className={css.footer__link}>Контакти</a>
            </li>
        ...
        <div className={css.contacts}>
          <ul className={css.contacts__list}>
            ...
            <li className={css.contacts__item}>
              <img className={css.menu__icon} src={InstaIcon} alt="instagram-icon" />
              <a
            ...
            <li className={css.contacts__item}>
              <img className={css.menu__icon} src={PhoneIcon} alt="Phone-icon" />
            ...
            <li className={css.contacts__item}>
              <img className={css.menu__icon} src={LocationIcon} alt="location-icon" />
              <a
